...
![](`r if(dir.exists("images")) paste0(getwd(),"/") else ""`images/icon.png){width=2px;height=2px}
...
use_real_data <- if("use_real_data" %in% names(config)) config$use_real_data else TRUE

raw_data <- load_data(use_real_data, config, params)$raw_data

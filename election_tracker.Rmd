...
![](`r if(dir.exists("images")) paste0(getwd(),"/") else ""`images/logo.png){width=50%}
...
write.csv(precinct_turnout, file="outputs/precinct_turnout.csv", row.names=FALSE)
...
gg_wards_relative(wards, current_time, config)

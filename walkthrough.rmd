...
## On Election Day
There are a few specifics that need to be handled on election day. The file `run_all.R` does four things: (a) download the google data, (b) calculate the bootstrapped estimate, (c) compiles `election_tracker.Rmd`, which creates the markdown report, (d) pushes the html to github using `upload_git.bat`, and then (e) maybe tweets an update.

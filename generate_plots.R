...
leaflet_wards_predicted <- function(wards, raw_data, config, current_time){
  make_leaflet(
    wards=wards, 
    raw_data=raw_data,
    config=config, 
...
leaflet_wards_change <- function(wards, raw_data, config, current_time){
  make_leaflet(
    wards=wards, 
    raw_data=raw_data,
    config=config, 
...
leaflet_submissions <- function(wards, raw_data, config, current_time){
  make_leaflet(
    wards=wards, 
    raw_data=raw_data,
    config=config, 
